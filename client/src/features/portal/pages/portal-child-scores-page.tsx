...
export function PortalChildScoresPage() {
    ...
    const gridQuery = useQuery({
        ...
        enabled:
            filtersReady && Boolean(studentId && yearFilter && semesterFilter),
        ...
        <div className='space-y-6'>
            <div>
                ...
                <h1 className='mt-2 text-2xl font-semibold'>
                    Bảng điểm — {child?.student.fullName ?? 'Học sinh'}
                </h1>
            ...
            {!filtersReady || childrenQuery.isLoading || gridQuery.isLoading ? (
