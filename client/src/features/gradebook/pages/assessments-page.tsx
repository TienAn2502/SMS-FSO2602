    ...
    const columns = useMemo<ColumnDef<GradebookOverviewItem>[]>(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <GradebookOverviewStatusBadge
                        status={row.original.gradebookStatus}
                    />
                ),
            },
            {
        ...
        <div className='space-y-6'>
            <div>
                ...
                <p className='text-sm text-muted-foreground'>
                    Giám sát tiến độ nhập điểm toàn trường — giáo viên nhập điểm
                    qua Portal.
                </p>
            </div>
            ...
            <Card>
                ...
                <CardContent className='space-y-4'>
                    ...
                    <div className='space-y-1'>
                        <Label htmlFor='gradebookStatusFilter'>
                            Trạng thái sổ
                        </Label>
                        <select
