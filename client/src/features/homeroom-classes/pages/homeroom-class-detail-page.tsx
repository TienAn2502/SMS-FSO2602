...
export function HomeroomClassDetailPage() {
    ...
    const teachersQuery = useQuery({
        ...
        queryFn: () =>
            fetchTeachers({
                ...
                page: 1,
                status: 'ACTIVE',
                availableAsHomeroomForAcademicYearId:
                    homeroomClass!.academicYearId,
    ...
    const gradeName = useMemo(() => {
        ...
        return (
            gradesQuery.data?.items.find(
                (g) => g.id === homeroomClass.gradeLevelId,
            )?.name ?? '—'
        );
        ...
        <div className='space-y-6'>
                    ...
                    >
                        ...
                        <div className='space-y-2'>
                            ...
                            <p className='text-xs text-muted-foreground'>
                                Chỉ hiện GV chưa làm GVCN lớp ACTIVE khác trong
                                cùng năm học.
                            </p>
                        </div>
                ...
                <CardContent className='space-y-4'>
                    ...
                    {!studentsQuery.isLoading && students.length > 0 ? (
                        <DataPagination
                            ...
                            totalPages={
                                studentsQuery.data?.meta.totalPages ?? 1
                            }
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Các lớp môn trong cùng năm học được gắn với lớp hành
                        chính này
                    </CardDescription>
                </CardHeader>
                <CardContent className='space-y-4'>
                    ...
                    {!sectionsQuery.isLoading && sections.length > 0 ? (
                        <DataPagination
                            ...
                            totalPages={
                                sectionsQuery.data?.meta.totalPages ?? 1
                            }
