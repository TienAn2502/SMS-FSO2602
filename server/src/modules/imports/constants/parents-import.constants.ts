...
export const PARENT_IMPORT_INSTRUCTION_LINES = [
  ...
  '',
  'Cột bắt buộc: ho_ten',
  'Cột tuỳ chọn: phone, email, mat_khau, ma_hs (mã HS external_code), quan_he (FATHER/MOTHER/GUARDIAN/OTHER hoặc Bố/Mẹ), lien_he_chinh (1/0, có/không)',
  '',
  'Quy tắc:',
  '- Nếu có email: tạo/cập nhật theo email (mat_khau tuỳ chọn; bỏ trống dùng mật khẩu mặc định hệ thống)',
  '- Không có email: luôn tạo hồ sơ phụ huynh mới',
